...
## Founder product correction (2026-07-12)

- **D030 — BidSpace is a pre-launch temporary vendor-space marketplace; applications return as a separate, amount-free submission and money movement is founder-gated.** Customer language leads with hosts, vendors, spaces, placements, bids, applications, invitations, venues, events, booths, pads, stalls, and kiosks. Bidding remains the core allocation method, but hosts may select application, invite-only, fixed-fee, host-approval, or waitlist modes. This partially supersedes D005's retirement of Application. D015, D018, D026, D028, and D029 remain dormant technical/economic research only: no Stripe checkout, Connect onboarding, fee collection, payout, booking creation from a bid, or binding placement may activate until a separate founder approval changes the checked-in marketplace gate. `LOCKED`
