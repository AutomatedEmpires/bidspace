...
> **Source of truth (see DECISIONS D018):** Notion holds product & vision truth; this repository holds implementation truth. On a *product/vision* conflict, Notion decides; on an *implementation* conflict, this repo decides. This supersedes the earlier "repo wins on everything" stance (D017).
