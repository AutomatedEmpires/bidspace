...
- Product/vision conflict → Notion decides. Implementation conflict → this repo decides. (See `docs/DECISIONS.md` D018, which supersedes D017's "repo wins on everything.")
