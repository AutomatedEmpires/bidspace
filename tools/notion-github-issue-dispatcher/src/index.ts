...
worker.tool("dispatchTaskToGithub", {
	...
	description:
		"Create a GitHub issue from a Notion handoff (Ready for Engineering) for the BidSpace repo, then write the created issue URL back to the Notion source page. This creates a real issue — confirm before running.",
	schema: j.object({
		notionSourceUrl: j
			.string()
		...
		const res = await fetch(
			`https://api.github.com/repos/${owner}/${repo}/issues`,
			{
				...
				headers: {
					...
					"User-Agent": "bidspace-issue-dispatcher",
				},
